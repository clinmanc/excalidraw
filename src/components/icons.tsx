...
export const BorderColorIcon = React.memo(
...
export const BackgroundColorIcon = React.memo(
  ({ theme, color }: { theme: Theme; color: string }) =>
    createIcon(
      <>
        <g fill={iconFillColor(theme)}>
          <path d="M1.2,0.2C1.3,0.1,1.4,0,1.6,0H1.2C0.5,0,0,0.5,0,1.2v0.4c0-0.1,0.1-0.3,0.2-0.4L1.2,0.2z" />
          <path d="M10.8,11.8c-0.2,0.1-0.3,0.2-0.5,0.2h0.5c0.7,0,1.2-0.5,1.2-1.2v-0.5c0,0.2-0.1,0.4-0.2,0.5L10.8,11.8z" />
          <path
            d="M6,0.2C6.1,0.1,6.3,0,6.5,0H1.6C1.8,0,2,0.1,2.1,0.2c0.1,0.1,0.2,0.3,0.2,0.5S2.2,1,2.2,1.1l-1,1
		C1,2.2,0.9,2.3,0.7,2.3S0.3,2.2,0.2,2.1C0.1,2,0,1.8,0,1.6v4.9C0,6.2,0.1,6,0.2,6L6,0.2z"
          />
          <path
            d="M10.8,0H6.5C6.7,0,6.8,0.1,7,0.2c0.1,0.1,0.2,0.3,0.2,0.5S7.1,1,7,1.2L1.2,6.9C1,7,0.9,7.1,0.7,7.1
		s-0.4,0-0.5-0.2C0.1,6.7,0,6.6,0,6.4v4.4C0,11.5,0.5,12,1.2,12h9.1c-0.2,0-0.4-0.1-0.5-0.2c-0.3-0.3-0.3-0.7,0-1l1-1
		c0.2-0.1,0.3-0.2,0.5-0.2s0.4,0.1,0.5,0.2c0.1,0.2,0.2,0.3,0.2,0.5V5.5c0,0.2-0.1,0.4-0.2,0.5L6,11.7c-0.2,0.1-0.3,0.2-0.5,0.2
		S5.2,11.8,5,11.7c-0.3-0.3-0.3-0.7,0-1L10.8,5c0.2-0.1,0.3-0.2,0.5-0.2s0.4,0.1,0.5,0.2C11.9,5.2,12,5.3,12,5.5V1.2
		C12,0.5,11.5,0,10.8,0z M11.3,1.7l-9.7,9.6c-0.2,0.1-0.3,0.2-0.5,0.2c-0.2,0-0.4-0.1-0.5-0.2c-0.1-0.2-0.2-0.3-0.2-0.5
		c0-0.2,0.1-0.4,0.2-0.5l9.7-9.6c0.2-0.1,0.3-0.2,0.5-0.2s0.4,0,0.5,0.2c0.1,0.2,0.2,0.3,0.2,0.5C11.5,1.4,11.4,1.6,11.3,1.7z"
          />
        </g>
        <g fill={color}>
          <path
            d="M11.3,9.6c-0.2,0-0.3,0.1-0.5,0.2l-1,1c-0.3,0.3-0.3,0.7,0,1c0.1,0.1,0.3,0.2,0.5,0.2s0.3-0.1,0.5-0.2l1-1
		c0.1-0.1,0.2-0.3,0.2-0.5s-0.1-0.3-0.2-0.5C11.7,9.7,11.5,9.6,11.3,9.6L11.3,9.6z"
          />
          <path
            d="M11.3,4.8c-0.2,0-0.3,0.1-0.5,0.2L5,10.7c-0.3,0.3-0.3,0.7,0,1c0.2,0.1,0.3,0.2,0.5,0.2s0.3-0.1,0.5-0.2L11.8,6
		C11.9,5.9,12,5.7,12,5.5c0-0.2-0.1-0.3-0.2-0.5C11.7,4.9,11.5,4.8,11.3,4.8z"
          />
          <path
            d="M10.8,0.5c-0.2,0-0.3,0.1-0.5,0.2l-9.7,9.6c-0.1,0.1-0.2,0.3-0.2,0.5s0.1,0.3,0.2,0.5c0.1,0.1,0.3,0.2,0.5,0.2
		s0.3-0.1,0.5-0.2l9.7-9.6c0.1-0.1,0.2-0.3,0.2-0.5s-0.1-0.3-0.2-0.5C11.2,0.5,11,0.5,10.8,0.5z"
          />
          <path
            d="M6.5,0C6.3,0,6.1,0.1,6,0.2L0.2,6C0.1,6,0,6.2,0,6.4c0,0.2,0.1,0.3,0.2,0.5s0.3,0.2,0.5,0.2S1,7,1.2,6.9L7,1.2
		C7.1,1,7.2,0.9,7.2,0.7S7.1,0.3,7,0.2C6.8,0.1,6.7,0,6.5,0L6.5,0z"
          />
          <path
            d="M1.6,0C1.4,0,1.3,0.1,1.2,0.2l-1,1C0.1,1.3,0,1.5,0,1.6C0,1.8,0.1,2,0.2,2.1c0.1,0.1,0.3,0.2,0.5,0.2S1,2.2,1.2,2.1l1-1
		c0-0.1,0.1-0.2,0.1-0.4S2.2,0.3,2.1,0.2C2,0.1,1.8,0,1.6,0L1.6,0z"
          />
        </g>
      </>,
      { width: 12, mirror: true },
...
export const OpacityIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path d="M5.93.23,2.55,3.62A4.82,4.82,0,0,0,1.1,7a4.82,4.82,0,0,0,1.45,3.37A4.79,4.79,0,0,0,9.32,3.62Zm-3.59,7A3.49,3.49,0,0,1,3.4,4.57L5.93,2,8.47,4.57a3.42,3.42,0,0,1,1,2.61Z" />
    </>,
    { width: 12, mirror: true },
  ),
);

export const LayersIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path d="M11.58,3.36,6.36.4a.71.71,0,0,0-.72,0l-5.27,3a.53.53,0,0,0-.31.47.58.58,0,0,0,.28.49l5.3,3a.71.71,0,0,0,.72,0l5.22-3a.59.59,0,0,0,.21-.81.53.53,0,0,0-.21-.21Z" />
      <path d="M10.41,5.86,6.12,8.3a.3.3,0,0,1-.26,0L1,5.5a.56.56,0,0,0-.56,0H.34a.57.57,0,0,0-.28.58.58.58,0,0,0,.28.49l5.3,3a.71.71,0,0,0,.72,0l5.24-3a.57.57,0,0,0,.29-.5.61.61,0,0,0-.62-.6.69.69,0,0,0-.28.08Z" />
      <path d="M10.41,8,6.06,10.51a.24.24,0,0,1-.26,0L1,7.69a.51.51,0,0,0-.53,0,.58.58,0,0,0-.37.46.59.59,0,0,0,.28.5l5.24,3a.71.71,0,0,0,.72,0l5.24-3a.62.62,0,0,0,.35-.5.61.61,0,0,0-.62-.6.69.69,0,0,0-.28.08Z" />
    </>,
    { width: 12, mirror: true },
  ),
);

export const AlignIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path d="M825.7536 168.5504H340.5824c-18.2272 0-32.9728 14.7456-32.9728 32.9728v98.304c0 18.2272 14.7456 32.9728 32.9728 32.9728h485.1712c18.2272 0 32.9728-14.7456 32.9728-32.9728v-98.304c0.2048-18.0224-14.7456-32.9728-32.9728-32.9728zM825.7536 690.9952H340.5824c-18.2272 0-32.9728 14.7456-32.9728 32.9728v98.304c0 18.2272 14.7456 32.9728 32.9728 32.9728h485.1712c18.2272 0 32.9728-14.7456 32.9728-32.9728v-98.304c0.2048-18.2272-14.7456-32.9728-32.9728-32.9728zM340.5824 594.3296h308.0192c18.2272 0 32.9728-14.7456 32.9728-32.9728v-98.304c0-18.2272-14.7456-32.9728-32.9728-32.9728H340.5824c-18.2272 0-32.9728 14.7456-32.9728 32.9728v98.304c0 18.0224 14.7456 32.9728 32.9728 32.9728zM191.0784 134.7584c-15.9744 0-29.0816 12.9024-29.0816 29.0816v696.32c0 15.9744 12.9024 29.0816 29.0816 29.0816s29.0816-12.9024 29.0816-29.0816V163.84c0-15.9744-12.9024-29.0816-29.0816-29.0816z" />
    </>,
    { width: 1024, mirror: true },
  ),
);
...
export const EdgeSharpIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <polyline
      className="cls-1"
      points="1.55 7.87 1.55 4.24 10.43 4.24"
      stroke={iconFillColor(theme)}
      strokeWidth={1}
      strokeLinecap="round"
      fill="none"
...
export const EdgeRoundIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <path
      d="M1.55,7.87V6.36A2.12,2.12,0,0,1,3.67,4.24h6.76"
      stroke={iconFillColor(theme)}
      strokeWidth={1}
      strokeLinecap="round"
      fill="none"
...
export const FontSizeSmallIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <path
      fill={iconFillColor(theme)}
      d="M1.8,7.88H4.63A1.21,1.21,0,0,0,5.71,9.21H6c.75,0,1.18-.35,1.18-.86C7.18,6.62,2,7.12,2,3.4,2,1.38,3.49.2,5.81.2A3.57,3.57,0,0,1,9.66,3.45c0,.11,0,.22,0,.33H6.94A1,1,0,0,0,5.78,2.61c-.82,0-1,.29-1,.71,0,1.59,5.19.94,5.19,4.91a3.45,3.45,0,0,1-3.39,3.51,2.9,2.9,0,0,1-.51,0,3.9,3.9,0,0,1-4.26-3.5C1.81,8.11,1.8,8,1.8,7.88Z"
    />,
    { width: 12 },
  ),
);
...
export const FontSizeMediumIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <path
      fill={iconFillColor(theme)}
      d="M10.92.21V11.77H8.62V8.93c0-1.41.12-2.81.18-4.21H8.72l-1,3L7.15,9.39H4.79L4.21,7.74l-1-3.06h0c0,1.41.12,2.81.17,4.21v2.88H1V.21H3.34L5.15,4.58c.23.58.63,1.65.76,2h0c.13-.43.53-1.44.76-2L8.55.21Z"
    />,
    { width: 12 },
  ),
);
...
export const FontSizeLargeIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <path
      fill={iconFillColor(theme)}
      d="M10.25,9.66v2.15H2.83V.27H5.14V9.5h5.11Z"
    />,
    { width: 12 },
  ),
);
  ...
  ({ theme }: { theme: Theme }) =>
    createIcon(
      <>
        <path
          fill={iconFillColor(theme)}
          d="M4.45,10.68,3.3,7.7l-1.14,3h-2L2.26,6l-2-4.47h2l1,2.65,1-2.65h2L4.31,6l2.14,4.7Z"
        />
        <path
          fill={iconFillColor(theme)}
          d="M11.88,8.88v1.8H7.3V1.57H9.15V8.88Z"
        />
      </>,
      { width: 12 },
    ),
...
export const FontFamilyHandDrawnIcon = React.memo(
  ({ theme }: { theme: Theme }) =>
    createIcon(
      <path
        fill={iconFillColor(theme)}
        d="M11.69,2,10.08.22a.9.9,0,0,0-1,.15l-.88.73,2.63,2.63L11.55,3C12,2.65,12,2.27,11.69,2ZM2.17,7.1,4.81,9.74,9.94,4.61,7.3,2.12Zm-2,4.69,3.66-1L1.29,8.13Z"
      />,
      { width: 12 },
    ),
);
...
export const FontFamilyNormalIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <path
      fill={iconFillColor(theme)}
      d="M6.76.16A.26.26,0,0,1,7,.31l4.39,11.24a.28.28,0,0,1,0,.22.27.27,0,0,1-.19.11H9.92a.21.21,0,0,1-.2-.15L8.64,9H3.48l-1.1,2.77a.24.24,0,0,1-.19.14H1a.31.31,0,0,1-.19,0,.28.28,0,0,1,0-.22L5.16.34A.2.2,0,0,1,5.34.16ZM6.1,2.36,4.15,7.18H8Z"
    />,
    { width: 12 },
  ),
);
...
export const FontFamilyCodeIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path
        fill={iconFillColor(theme)}
        d="M7.23,1.15a.79.79,0,0,0-.93.56l-2,8.3a.76.76,0,0,0,1.46.43v0L7.77,2.06a.72.72,0,0,0-.49-.89h0Z"
      />
      <rect
        fill={iconFillColor(theme)}
        x="-0.05"
        ...
        width="4.43"
        height="1.48"
        transform="translate(-2.91 3.18) rotate(-47.41)"
      />
      <rect
        fill={iconFillColor(theme)}
        x="1.43"
        ...
        width="1.48"
        height="4.43"
        transform="matrix(0.74, -0.68, 0.68, 0.74, -4.28, 3.36)"
      />
      <rect
        fill={iconFillColor(theme)}
        x="9.09"
        ...
        width="1.48"
        height="4.43"
        transform="translate(-0.74 7.96) rotate(-42.59)"
      />
      <rect
        fill={iconFillColor(theme)}
        x="7.6"
        ...
        width="4.43"
        height="1.48"
        transform="translate(-2.12 9.55) rotate(-47.41)"
      />
    </>,
    { width: 12 },
  ),
...
export const TextAlignLeftIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path
        d="M9.5,2.5h-7C2.224,2.5,2,2.724,2,3s0.224,0.5,0.5,0.5h7C9.776,3.5,10,3.276,10,3S9.776,2.5,9.5,2.5z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M6.5,4h-4C2.224,4,2,4.224,2,4.5S2.224,5,2.5,5h4C6.776,5,7,4.776,7,4.5S6.776,4,6.5,4z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M8.5,5.5h-6C2.224,5.5,2,5.724,2,6s0.224,0.5,0.5,0.5h6C8.776,6.5,9,6.276,9,6S8.776,5.5,8.5,5.5z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M6.5,7h-4C2.224,7,2,7.224,2,7.5S2.224,8,2.5,8h4C6.776,8,7,7.776,7,7.5S6.776,7,6.5,7z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M9.5,8.5h-7C2.224,8.5,2,8.724,2,9s0.224,0.5,0.5,0.5h7C9.776,9.5,10,9.276,10,9S9.776,8.5,9.5,8.5z"
        fill={iconFillColor(theme)}
      />
    </>,
    { width: 12 },
...
export const TextAlignCenterIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      ...
      />
      <path
        d="M8,4H4C3.724,4,3.5,4.224,3.5,4.5S3.724,5,4,5h4c0.276,0,0.5-0.224,0.5-0.5S8.276,4,8,4z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M9,5.5H3C2.724,5.5,2.5,5.724,2.5,6S2.724,6.5,3,6.5h6c0.276,0,0.5-0.224,0.5-0.5S9.276,5.5,9,5.5z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M8,7H4C3.724,7,3.5,7.224,3.5,7.5S3.724,8,4,8h4c0.276,0,0.5-0.224,0.5-0.5S8.276,7,8,7z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M9.5,8.5h-7C2.224,8.5,2,8.724,2,9s0.224,0.5,0.5,0.5h7C9.776,9.5,10,9.276,10,9S9.776,8.5,9.5,8.5z"
...
export const TextAlignRightIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      ...
      />
      <path
        d="M9.5,4h-4C5.224,4,5,4.224,5,4.5S5.224,5,5.5,5h4C9.776,5,10,4.776,10,4.5S9.776,4,9.5,4z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M9.5,5.5h-6C3.224,5.5,3,5.724,3,6s0.224,0.5,0.5,0.5h6C9.776,6.5,10,6.276,10,6S9.776,5.5,9.5,5.5z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M9.5,7h-4C5.224,7,5,7.224,5,7.5S5.224,8,5.5,8h4C9.776,8,10,7.776,10,7.5S9.776,7,9.5,7z"
        fill={iconFillColor(theme)}
      />
      <path
        d="M9.5,8.5h-7C2.224,8.5,2,8.724,2,9s0.224,0.5,0.5,0.5h7C9.776,9.5,10,9.276,10,9S9.776,8.5,9.5,8.5z"
