...
export const BackgroundColorIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path d="M10.27,1.59v8.56H1.71V1.59h8.56M11.61.24H.35V11.51H11.61Z" />
      <rect x="0.58" y="0.38" width="5.36" height="5.44" fill={theme} />
      <rect x="5.99" y="5.73" width="5.36" height="5.44" fill={theme} />
    </>,
    { width: 12, mirror: true },
  ),
);
